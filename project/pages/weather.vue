<template>
    <div id="weatherApp" class="h-screen flex flex-col justify-center items-center">
        <home-link class="hover:text-blue-300"/>
        <h1 class="text-4xl text-blue-300">Weather</h1>
        <div id="app" class="w-64 h-64 mt-4 bg-blue-200 rounded-xl flex flex-col justify-center items-center">
            <p id="location"></p>
        </div>
    </div>
</template>
